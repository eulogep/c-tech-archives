...
La baseline actuelle contient **299 tests**. Le contrôle de déploiement local affiche cinq warnings attendus lorsque le développement conserve HTTP et `DEBUG=True` :
