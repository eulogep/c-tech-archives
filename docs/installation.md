...
La baseline actuelle contient **280 tests**. Le contrôle de déploiement local affiche cinq warnings attendus lorsque le développement conserve HTTP et `DEBUG=True` :
