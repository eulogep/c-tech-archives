...
> **Le MVP est-il certifié OWASP ou prêt production immédiatement ?** Non. Il possède une revue de sécurité et 299 tests, mais pas de pentest externe, de certification, ni toutes les mesures d’exploitation nécessaires.
