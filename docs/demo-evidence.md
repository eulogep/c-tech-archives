...
| La sécurité est testée transversalement | Présenter le résultat de la suite de test | 299 tests réussis ; durcissement couvert | `HARD-001` à `HARD-026` | Exécuter `python manage.py test` ou montrer la sortie enregistrée |
