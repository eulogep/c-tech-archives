...
| 6:00–6:30 | Tests et limites | Montrer la suite de 255 tests. Terminer avec les limites : pas de MFA, antivirus, versioning, SIEM/WORM, chiffrement applicatif ou pentest externe. |
...
| 1:50–2:00 | Preuve | « Le projet possède 255 tests automatisés et documente ses limites de production. » |
